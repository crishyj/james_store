...
$upload_dir = '/creator/ebooks/'; // path from base_url to base of upload folder (with start and final /)


$current_path = '../ebooks/'; // relative path from filemanager folder to upload folder (with final /)
