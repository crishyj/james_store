tinymce.PluginManager.add("audio", function(e) {
    ...
    function t() {
        ...
        function r() {
            ...
            "" === n.width && (n.width = null), "" === n.height && (n.height = null), "" === n.style && (n.style = null), n = {
                ...
                height: n.height,
                style: n.style
            }, f ? d.setAttribs(f, n) : (n.id = "__mcenew", e.insertContent(d.createHTML("audio", n)), f = d.get("__mcenew"), d.setAttrib(f, "id", null)), t(f)
        }
        function i(e) {
