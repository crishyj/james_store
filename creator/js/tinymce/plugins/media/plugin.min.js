...
tinymce.PluginManager.add('media', function(editor, url) {
	...
	function dataToHtml(data) {
		...
		if (data.embed) {
			...
			if (data.type == "iframe") {
				...
				if (data.poster) {
					html += '<img src="' + data.poster + '" style="width:' + data.width + 'px; height:' + data.height + 'px;" />';
				}
	...
	editor.on('preInit', function() {
		...
		// Allow elements
		editor.schema.addValidElements('object[id|style|width|height|classid|codebase|*],embed[id|style|width|height|type|src|*],video[*],audio[*],iframe[width|height|marginwidth|name|*]');
