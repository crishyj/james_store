...
class Readability
{
	...
	**/
	public $regexps = array(
		'unlikelyCandidates' => '/combx|comment/i',
		'okMaybeItsACandidate' => '/and|article|body|column|main-container|shadow/i',
		'positive' => '/article|body|content|entry|hentry|main|page|pagination|post|text|blog|container/i',
		'negative' => '/combx/i',
	...
	*/
	...
	public function getBas(){
		...
		//$this->prepDocument();
		//return $this->dom->getElementsByTagName('body')->innerHTML;
	}
