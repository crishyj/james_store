		...
		showError : function(type, data){
			...
			switch(type){
				...
				case Messages.ERROR_EPUB:
					...
					break;
				case Messages.ERROR_BUY_CARD:
					msg = Strings.error_buy_card;
					break;
				case Messages.ERROR_LOGIN:
					msg = Strings.error_login;
					break;
				case Messages.ERROR_SEARCH:
					msg = Strings.error_search;
					break;
				default: 
