...
// grab the allow_users_to_disable_ni data from the post and add it to the 
// External Authentecation settings
$PHORUM["phorum_mod_external_authentication"]["allow_users_to_disable_ni"] = empty($_POST["allow_users_to_disable_ni"]) ? 0 : 1;
